...
var app = app_mod.Create(config.appid,config.proxy_addrs,config.passwd);//这里的appid要修改成自己的
console.log(config.appid,config.proxy_addrs);
var mgr_moudle_path = "./server/logic";//在这里你可以自己定义自己的逻辑模块
